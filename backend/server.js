...
const { schemes, alerts } = require('./data');
...
// MongoDB connects asynchronously after the server is up.
app.listen(PORT, '0.0.0.0', () => {
  console.log(`Nexora AgriConnect backend running on http://0.0.0.0:${PORT}`);
  connectDB();
});